                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-sm-12 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('menu.update', ['slug' => $data->slug]) }}" method="POST"
                                    ...
                                    <div class="row d-lg-flex align-items-center justify-content-center">
                                        ...
                                        <div class="col-lg-10 mb-3 mx-auto">
                                            ...
                                            @enderror"
                                                ...
                                                autocomplete="off" required value="{{ $data->harga }}">
                                            @error('harga')
                                                <div id="validationServer03Feedback" class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        is-invalid
                                    @enderror cols="5"
                                                rows="4" name="deskripsi" id="deskripsi" required>{{ $data->deskripsi }}</textarea>
                                            @error('deskripsi')
                                                <div id="validationServer03Feedback" class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-lg-10 mb-3 mx-auto">
                                            ...
                                            <div>
                                                <img src="{{ asset("storage/menu/$data->gambar") }}" alt="gambar"
                                                    class="image-view">
                                            </div>
                                        ...
                                        <div class="col-lg-10 mb-3 mx-auto">
                                            <input class="btn btn-success btn-block" type="submit" value="Ubah Menu">
                                        </div>
